...
import type { LoginBody, RefreshBody, RegisterBody } from '../validations/auth.validator.ts';
...
export const refresh: RequestHandler = async (req, res, next) => {
  try {
    ...
    const refreshTokenFromCookie = req.cookies?.[config.REFRESH_TOKEN_COOKIE] as string | undefined;
